(() => {
  ...
  // https-util:https://cdn.bootcdn.net/ajax/libs/lodash.js/4.17.21/lodash.core.js
  var require_lodash_core = __commonJS({
    "https-util:https://cdn.bootcdn.net/ajax/libs/lodash.js/4.17.21/lodash.core.js"(exports, module) {
      (function() {
        var undefined2;
        var VERSION = "4.17.21";
        ...
        function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
          ...
          if (isSameTag && !objIsObj) {
            var result2 = objIsArr ? equalArrays(object, other, bitmask, customizer, equalFunc, stack) : equalByTag(object, other, objTag, bitmask, customizer, equalFunc, stack);
            stack.pop();
            return result2;
          }
          if (!(bitmask & COMPARE_PARTIAL_FLAG)) {
            ...
            if (objIsWrapped || othIsWrapped) {
              ...
              var result2 = equalFunc(objUnwrapped, othUnwrapped, bitmask, customizer, stack);
              stack.pop();
              return result2;
            }
          }
          ...
          var result2 = equalObjects(object, other, bitmask, customizer, equalFunc, stack);
          stack.pop();
          return result2;
        }
          ...
          while (++index < arrLength) {
            ...
            if (seen) {
              if (!baseSome(other, function(othValue2, othIndex) {
                if (!indexOf(seen, othIndex) && (arrValue === othValue2 || equalFunc(arrValue, othValue2, bitmask, customizer, stack))) {
  ...
  var Test = () => {
    return /* @__PURE__ */ import_react.default.createElement("div", null, "xxx");
  };
  var Test_default = Test;

  // src/abc-env.js
  var import_lodash_core = __toModule(require_lodash_core());
  console.log(import_lodash_core.default);
  var abc_env_default = {
    a: "111"
  };

  // App.jsx
  console.log(abc_env_default.a);
  var Greet = () => /* @__PURE__ */ React2.createElement("h1", null, "Hello, world!", /* @__PURE__ */ React2.createElement(Test_default, null));
  console.log(Server.renderToString(/* @__PURE__ */ React2.createElement(Greet, null)));
})();
/*
object-assign
(c) Sindre Sorhus
